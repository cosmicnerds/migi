// {Name: Hello_World}
// {Description: Hello World example of the migi Platform functionality: intent() / play() / user- and pre-defined slots / contexts}

// Welcome to the migi Platform.
// This example will introduce you to the main principles of migi scripts and teach you how to create basic voice commands for your application.
...
corpus(`
    ...
    I consider migi to be my family.
    My name comes from migi Turing, the British mathematician and computer scientist who laid the foundation of artificial intelligence.
...
intent(
    ...
    p => {
        p.play(
            'My name is migi created by Vaibhav and jisha.',
            'It\'s migi.',
        );
    },
);
...
// On the Migi Platform you can define such contexts (https://alan.app/docs/server-api/contexts#defining-contexts).
...
// Notice that the first time you will ask about the context being active migi can't match your command.
